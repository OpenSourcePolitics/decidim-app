...
gem "decidim-dataspace", git: "https://github.com/OpenSourcePolitics/decidim-module-dataspace.git"
...
gem "decidim-multipod_iframe", git: "https://github.com/OpenSourcePolitics/decidim-module-multipod_iframe.git"
