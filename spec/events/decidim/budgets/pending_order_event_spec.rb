...
describe Decidim::Budgets::PendingOrderEvent do
  ...
  describe "email_intro" do
    it "is generated correctly" do
      expect(subject.email_intro).to eq("The budget \"#{resource_title}\" is not confirmed yet in \"#{participatory_space_title}\".")
    end
  end
  ...
  describe "notification_title" do
    it "is generated correctly" do
      expect(subject.notification_title)
          .to eq("The budget <a href=\"#{resource_path}\">#{resource_title}</a> is still waiting for your confirmation in in #{participatory_space_title}")
    end
  end
