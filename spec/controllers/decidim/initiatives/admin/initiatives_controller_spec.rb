...
describe Decidim::Initiatives::Admin::InitiativesController do
  ...
  context "when edit" do
    ...
    context "and admin users" do
      ...
      context "and initiative description contains a javascript event" do
        let!(:my_initiative) { create(:initiative, organization: organization, description: { en: 'img src="invalid.jpg" onerror="alert();">' }) }

        it "modifies description value" do
          get :edit, params: { slug: my_initiative.to_param }
          expect(response.body).to include("nothingalert()")
        end
      end
    end
