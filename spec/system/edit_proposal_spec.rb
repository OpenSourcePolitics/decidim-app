...
describe "Edit proposals" do
  ...
  describe "editing my own proposal without category and scope mandatory" do
    ...
    context "when attachments are allowed" do
      let(:component) { create(:proposal_component, :with_attachments_allowed, participatory_space: participatory_process, settings:) }
    ...
    context "when updating with wrong data" do
      let(:component) { create(:proposal_component, :with_creation_enabled, :with_attachments_allowed, participatory_space: participatory_process, settings:) }
