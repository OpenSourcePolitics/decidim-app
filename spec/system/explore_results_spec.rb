  ...
  context "when there are results" do
    ...
    describe "show" do
      ...
      context "with timeline entries" do
        ...
        context "and timeline's description contains an image" do
          let!(:image_blob) do
          ...
          before do
            ...
            timeline_entry.update!(description: { "en" => "<p>Timeline description</p><img src=\"#{image_url}\" alt=\"city_image\">" })
          end
          ...
          it "displays the image" do
            ...
            expect(page).to have_css("img[alt=city_image]")
          end
        end
      end
