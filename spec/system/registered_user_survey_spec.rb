...
describe "Answer a survey" do
  ...
  context "when the survey allow answers" do
    ...
    before do
      ...
      Decidim::Forms::Answer.where(decidim_user_id: user.id).destroy_all
    ...
    it "allows answering the questionnaire" do
      ...
      expect(Decidim::Surveys::SurveyConfirmationMailer).to have_received(:confirmation).with(user, questionnaire, [[questionnaire.answers.first, questionnaire.answers.last]])
